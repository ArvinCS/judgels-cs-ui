...
class BundleCard extends PureComponent {
          ...
          <ContentCard className="bundle-card">
            <h4 className="bundle-card-name">
              ...
              <div className="bundle-card-status">
                <BundleEditDialog
                  canManage={this.state.role === 'ADMIN' || this.state.role === 'MANAGER'}
                  role={this.state.role}
                  bundle={this.state.bundle}
                  onEditDone={this.fetchBundleData}
                />
    ...
    return (
      <>
        <div className="bundle-card-pagination-container">
          <PaginationTable pageSize={BundleCard.PAGE_SIZE} onChangePage={this.onChangePage} />
        </div>
      </>
    );
  };
  ...
  fetchBundleData = () => {
    ...
    this.props
      .onGetBundleByJid(this.state.bundle.jid)
      .then(response => {
