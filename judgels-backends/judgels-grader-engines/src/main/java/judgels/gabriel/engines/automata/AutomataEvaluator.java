...
public class AutomataEvaluator implements Evaluator {
    ...
    public void prepare(
        ...
        this.executableFilename = machine.getExecutableFilename(sourceFile.getName());
        this.solutionCommand = machine.getExecutionCommand(sourceFile.getName());
