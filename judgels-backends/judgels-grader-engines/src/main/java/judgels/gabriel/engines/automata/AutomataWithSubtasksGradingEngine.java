...
public class AutomataWithSubtasksGradingEngine extends BlackboxGradingEngine {
    ...
    public AutomataWithSubtasksGradingEngine() {
    ...
    public GradingConfig parseConfig(ObjectMapper mapper, String json) throws IOException {
        return mapper.readValue(json, AutomataWithSubtasksGradingConfig.class);
    }
    ...
    public void prepare(
        ...
        AutomataWithSubtasksGradingConfig cfg = (AutomataWithSubtasksGradingConfig) config;
